...
public class Utils {
    ...
    public Boolean installAPK(Context context, Uri apkUri, Callback callbackContext) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                success = false;
                callbackContext.invoke(returnErrorInvoke("Device Owner not enabled. Strategy CUSTOM required Device Owner!"));
            }

        } catch (Exception e) {
            success = false;
            Log.e(PushLinkManager.TAG, "Exception InstallAPK: " + e.getMessage());
            callbackContext.invoke(returnErrorInvoke("Error installAPK: " + e.getMessage()));
        }
    ...
    public Boolean isDeviceOwner(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            try {
                ...
                Log.e(PushLinkManager.TAG, "Throwable isDeviceOwner:", t);
            }
    ...
    public String returnErrorInvoke(String error) {
        ...
        try {
            ...
            Log.e(PushLinkManager.TAG, "PUSHLINK returnErrorInvoke", e);
        }
